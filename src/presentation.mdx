...
<Image src="./assets/iknowthatfeel.jpeg" />
...
## **Nobody** is going to say that you application is awesome because you are using hooks
...
## From time to time companies remind use that their **main goal is to earn money**
...
<Video src="./assets/pied-piper.mp4" />
...
- The dependency was designed to tried to steal you bitconins wallet
...
--allow-read=/tmp  --allow-net=google.com
```
